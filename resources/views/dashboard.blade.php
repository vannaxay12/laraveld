...
<div id="wind-info">ຄວາມເລວລົມ: <span id="wind-speed">0</span></div>

<div id="info-left">
  {{-- <button onclick="goToSecondPage()">ກັບໜ້າຫຼັກ</button> --}}
  <h3><span class="name">ຄົນຫຼີ້ນ</span></h3>
  <p>ມຸມ: <span class="angle">0</span>°</p>
  <p>ຄວາມເລວ: <span class="velocity">0</span></p>
  <script>
...
<div id="info-right">
  ...
  <h3><span class="name">ຄອມ</span></h3>
  <p>ມຸມ: <span class="angle">0</span>°</p>
  <p>ຄວາມເລວ: <span class="velocity">0</span></p>
</div>

<div id="instructions">
  <h3 id="game-mode">ຫຼີ້ນຄົນດຽວ</h3>
  <h1>ຄິກຊ້າຍລາກທີ່ໝາກບານເພື່ອເລີ້ມເກມ!</h1>
</div>

<div id="bomb-grab-area"></div>

<div id="congratulations">
  <h1><span id="winner">?</span> ຊະນະ!</h1>
  
 
  <div class="dropdown">
    <button class="dropbtn">ເລືອກຮູບແບບເກມ</button>
    <div class="dropdown-content">
      <a href="#" class="single-player">ຫຼີ້ນຄົນດຽວ</a>
      <a href="#" class="two-players">ຫຼີ້ນ2ຄົນ</a>
      <a href="#" class="auto-play">ຄອມຫຼີ້ນເອງ</a>
    </div>
  </div>
</div>
...
<div id="settings">
  ...
  <button id="color-mode">ໂໝດມືດ</button>
  ...
  {{-- <div id="youtube-card">
    ຮຽນຮູ້ວິທີການຂຽນCode ເກມນີ້ກັບດ້ວຍ Plain JavaScript ແລະ HTML Canvas
  </div> --}}
</div>
<script>
  /*
...
colorModeButtonDOM.addEventListener("click", () => {
  if (settings.mode === "dark") {
    settings.mode = "light";
    colorModeButtonDOM.innerText = "ໂໝດມືດ";
  } else {
    settings.mode = "dark";
    colorModeButtonDOM.innerText = "ໂໝດແຈ້ງ";
  }
  draw();
});
...
function announceWinner() {
  if (settings.numberOfPlayers === 0) {
    winnerDOM.innerText = `ຄອມ ${state.currentPlayer}`;
  } else if (settings.numberOfPlayers === 1 && state.currentPlayer === 1) {
    winnerDOM.innerText = `ເຈົ້າ`;
  } else if (settings.numberOfPlayers === 1 && state.currentPlayer === 2) {
    winnerDOM.innerText = `ຄອມ`;
  } else {
    winnerDOM.innerText = `ຄົນຫຼີ້ນ ${state.currentPlayer}`;
  }
  showCongratulations();
}
...
singlePlayerButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    ...
    name1DOM.innerText = "ຄົນຫຼີ້ນ";
    name2DOM.innerText = "ຄອມ";
...
twoPlayersButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    ...
    name1DOM.innerText = "ຄົນຫຼີ້ນ 1";
    name2DOM.innerText = "ຄົນຫຼີ້ນ 2";
...
autoPlayButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    settings.numberOfPlayers = 0;
    name1DOM.innerText = "ຄອມ 1";
    name2DOM.innerText = "ຄອມ 2";
